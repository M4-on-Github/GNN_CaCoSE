...
\midrule
All three & --- & 24.8 min compute, 11.8 min wall & --- \\
\bottomrule
\end{tabular}
...
Independent evidence that the pipeline is nonetheless stable: an earlier CPU run at a different
commit gave Cora $84.62 \pm 1.91$ and Chameleon $67.25 \pm 2.24$, against $84.64$ and $67.19$ here.
Agreement to roughly $0.06$ across a change of hardware, backend and commit is a stronger check
than bitwise determinism on one machine would have been.
